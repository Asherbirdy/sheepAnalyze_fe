import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef as toRef$1, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, ref, defineComponent, unref, h, Suspense, nextTick, mergeProps, provide, toRefs, toValue, onScopeDispose, readonly, customRef, onServerPrefetch, useSSRContext, watch, withCtx, createVNode, resolveDynamicComponent, createBlock, renderSlot, openBlock, toDisplayString, resolveComponent, useSlots, createCommentVNode, Fragment, createTextVNode, withModifiers, renderList, markRaw, useId, onErrorCaptured, createApp } from 'vue';
...
export { UIcon as U, __nuxt_component_0 as _, useAsyncData as a, useRequestFetch as b, useRuntimeConfig as c, useNuxtApp as d, __nuxt_component_2$1 as e, fetchDefaults as f, useRouter as g, useButtonGroup as h, useComponentIcons as i, UAvatar as j, _appConfig as k, useAppConfig as l, get as m, ULink as n, ULinkBase as o, pickLinkProps as p, makeDestructurable as q, reactivePick as r, camelize as s, tv as t, useHead as u, createSharedComposable as v, reactiveOmit as w, omit as x, server as y };
